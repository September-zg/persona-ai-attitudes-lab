...
function render() {
  ...
  if (page === 'intro') {
    shell(`${heading('Personality & AI Attitudes Lab', '测评实验室 · 教育研究探索')}
      <p>这是一个教育/研究探索性质的测评，用于描述人格特征与 AI 态度。预计用时 3–5 分钟。</p>
      <p class="muted intro-privacy">我们只保存匿名答题、汇总分数和可选体验反馈，不收集姓名或联系方式。参与完全自愿，你可以在提交前随时退出，不会影响任何权益。</p>
      <p class="muted intro-disclaimer">本测评不是临床、医学诊断或招聘筛选工具；数据仅用于本课程/研究探索。</p>
